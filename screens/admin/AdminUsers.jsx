...
//       // Check if the entered OTP matches the machine's OTP
//       if (otpInput !== selectedMachine.otp) {
...
//       const otpExpiryTime = new Date(selectedMachine.otpVerifyExpiryTime);
//       const now = new Date();
...
//       // Calculate usage expiry time (60 seconds from now for demo purposes)
//       // In a real application, this would be much longer (e.g., 30-60 minutes)
//       const expiryTime = new Date();
//       expiryTime.setSeconds(expiryTime.getSeconds() + 60);

//       // Update machine status
//       await firestore().collection('machines').doc(selectedMachine.id).update({
...
//                       <Text style={styles.userInfoLabel}>Expected OTP:</Text>
//                       <Text style={styles.otpValue}>{selectedMachine.otp}</Text>
//                     </View>
